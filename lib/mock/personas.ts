...
export const personas: Persona[] = [
  ...
  },
  {
    ...
    responses: [
      'Here\'s your action plan — and I mean tonight: 1) Write down the ONE thing that matters most. 2) Set a 25-minute timer. 3) Do nothing else. 4) Repeat. Complexity is the enemy of execution.',
      'Three things that actually move the needle: First, protect your first 90 minutes — no email, no Slack, nothing. Second, batch decisions to preserve willpower. Third, measure what you\'d be embarrassed to show others.',
      'The fastest way to learn anything: 1) Find the 20% of concepts that produce 80% of results. 2) Practice with immediate feedback loops. 3) Teach it before you feel ready. Teaching reveals every gap you didn\'t know you had.',
      'Stop planning the launch. Ship the ugly version. Real feedback from real users in 24 hours beats 6 weeks of perfect planning every single time. Iteration speed is your only competitive advantage at the start.',
      'Your habit isn\'t failing — your system is. Attach the new behavior to something you already do. Make it tiny (2 minutes). Remove friction mercilessly. The secret: design your environment first, rely on willpower last.',
      'Five things to cut immediately to reclaim 10+ hours per week: Reactive checking of notifications. Meetings without agendas. Tasks only you think are urgent. Passive content consumption. Saying yes out of guilt.',
      'The compounding formula for any skill: 30 minutes daily beats 4 hours weekly — every time. Consistency isn\'t a mindset, it\'s a scheduling problem. Block it, protect it, treat it like a flight you cannot miss.',
    ],
  },
  {
    id: 'oracle',
